...
Route::group(
    ...
    function () {
        ...
        Route::prefix('products')->as('products.')->controller(ProductController::class)->middleware(['isAdmin'])->group(function () {
            Route::get('', 'index')->name('index')->middleware('can:all_product');
            Route::get('create', 'create')->name('create')->middleware('can:add_product');
            Route::get('show/{product}', 'show')->name('show')->middleware('can:view_product');
            Route::post('store', 'store')->name('store')->middleware('can:add_product');
            Route::get('edit/{product}', 'edit')->name('edit')->middleware('can:edit_product');
            Route::put('update/{product}', 'update')->name('update')->middleware('can:edit_product');
            Route::delete('delete/{product}', 'destroy')->name('destroy')->middleware('can:delete_product');
        });
